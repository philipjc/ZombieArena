...
int createBackground(VertexArray& rVA, IntRect arena)
{
	...
	//  these refer to the width and height of the world in the number of tiles, not pixels.
	...
	// width * height * vertices equates to exactly the number of vertices
	// that our vertex array will have when we are done preparing it.
	...
	for (int w = 0; w < worldWidth; w++)
	{
		for (int h = 0; h < worldHeight; h++)
		{
			...
			else
			{
				...
				/*
					code starts by seeding the random number generator 
				...
				*/
				...
				int mudOrGrassTile = (rand() % TILE_TYPES);
				int verticalOffset = mudOrGrassTile * TILE_SIZE;
